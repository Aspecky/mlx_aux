...
/*   Updated: 2026/01/10 19:07:18 by mtarrih          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				hook_list_free(t_hook_node *head,
						void (*free_func)(void *));
void				hook_list_remove_if(t_hook_node **head,
						int (*predicate)(void *, void *), void *compare_data,
						void (*free_func)(void *));
